...
import FooterImg from '../Assets/navLogo.png'
            ...
            <footer className="text-white bg-primary">
                <div className="mx-auto w-full max-w-screen-xl p-4">
                    <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                        <div>
                            <img src={FooterImg} className='h-12 w-12 mx-10' />
                            <h2 className="mb-6 text-2xl font-semibold whitespace-nowrap text-mixed-orange uppercase dark:text-white">Capricorn</h2>
                        ...
                        <div>
                            <h2 className="mb-6 text-lg font-semibold text-beige uppercase dark:text-white">Help center</h2>
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                        ...
                        <div>
                            <h2 className="mb-6 text-lg font-semibold text-beige uppercase dark:text-white">Legal</h2>
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                        ...
                        <div>
                            <h2 className="mb-6 text-lg font-semibold text-beige uppercase dark:text-white">Download</h2>
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                    ...
                    <div className="px-4 py-6 bg-primary dark:bg-gray-700 md:flex md:items-center md:justify-between">
                        ...
                        <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
                            <a href="#" className="text-gray-400  hover:text-mixed-orange ">
                            ...
                            <a href="#" className="text-gray-400 hover:text-mixed-orange dark:hover:text-white">
